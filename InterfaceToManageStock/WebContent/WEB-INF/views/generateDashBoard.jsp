...
<div align="center">
  ...
  <h3> <a href="/InterfaceToManageStock/dailyProfitDashboard" id="listAll">List All Area Details</a></h3>
    ...
    <thead>
        ...
        <tr style="${details.profit_or_loss == 'profit' ? 'background-color:#6FE34F' : 'background-color:#FB0D02'}">
            <td>${details.id}</td>
